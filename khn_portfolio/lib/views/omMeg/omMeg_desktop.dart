    ...
    return Row(
      ...
      children: [
        Flexible(
          flex: 1,
          fit: FlexFit
              .loose, // Makes the set fit have presedence over Flexible class as long as the container can afford the space.
          child: Center(
            child: Container(
              padding: EdgeInsets.fromLTRB(20, 0, 20,
                  0), // Sets the outer padding of the image container
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color:
                          const Color.fromRGBO(47, 90, 200, 1).withOpacity(1),
